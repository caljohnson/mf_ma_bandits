...
if __name__ == '__main__':
	...
	bandit = MF_GaussianBandit(k=no_arms, m=no_fids, mu=means, sigma=.2, zeta=zeta, costs=costs)
	#bandit.plot_rewards()
	...
	# arm_plays_sf = plt.bar(index, plays2[:,2], bar_width, color='k', label='Fid 2 (UCB)')
	# plt.xlabel('Arm')
	# plt.ylabel('Plays')
